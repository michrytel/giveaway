        ...
        <div className="step__fourth">
            ...
            <div className="fourth__content">
                <div className="fourth__first">
                    ...
                    <input id="street" type="text" name="address.street" value={values.address.street}
                           onChange={handleChange}/>
                    <label htmlFor="city">City</label>
                    <input id="city" type="text" name="address.city" value={values.address.city}
                           onChange={handleChange}/>
                    <label htmlFor="postal">Postal Code</label>
                    <input id="postal" type="text" name="address.postal" value={values.address.postal}
                           onChange={handleChange}/>
                    <label htmlFor="phone">Phone number</label>
                    <input id="phone" type="text" name="address.phone" value={values.address.phone}
                           onChange={handleChange}/>
                </div>
